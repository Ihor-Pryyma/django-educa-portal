    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(limit_choices_to={'model__in': {'video', 'image', 'file', 'text'}}, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype')),
